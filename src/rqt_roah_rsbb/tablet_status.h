...
#ifndef __RQT_ROAH_RSBB_TABLET_STATUS_H__
#define __RQT_ROAH_RSBB_TABLET_STATUS_H__
...
namespace rqt_roah_rsbb
{
    ...
    : public rqt_gui_cpp::Plugin
  {
    ...
    private:
      ...
      const ros::Duration WARN_DURATION;
      ros::Time last_call_rcvd_;
      ros::Time last_call_time_;
      ros::Time last_pos_rcvd_;
